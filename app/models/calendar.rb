class Calendar < ActiveRecord::Base
  ...
  attr_accessible :event, :event_location, :event_time, :whendate, :important, :latitude, :longitude, :done, :remind_before, :remind_before_what, :reminder_time, :category_str, :note, :priority, :sync,:gcal_id
  #Validation
